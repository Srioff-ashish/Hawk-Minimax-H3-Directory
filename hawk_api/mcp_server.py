...
def build_mcp(service: HawkService, drive=None, imports=None) -> MCPServer:
    ...
    @mcp.tool(description=(
        ...
        "only. With a SINGLE reference use no tag: Qwen expects one image referred to naturally ('the image', 'the "
        "woman in the image'), and a tag it is not expecting is noise. Krea 2 takes references as latents and never "
